...
// Original Entra/MSAL-authenticated app shell — this is what App.tsx rendered before the
// additive AUTH_MODE=mock branch was introduced (see App.tsx / App.mock.tsx). Only additive
// change since then: passing the account name + a logoutRedirect() call into AgentChat's
// sign-out UI.
export function EntraApp() {
            ...
            {agentMetadata && (
              <div className="app-container">
                <AgentChat 
                  ...
                  onSignOut={() => instance.logoutRedirect({ account: user ?? null })}
                />
              </div>
            )}
          </AuthenticatedTemplate>
